...
class Conv4Encoder(nn.Module):
    ...
    This extracts features from input images to produce a fixed-size feature vector.
    4 convolutional blocks with ReLU and MaxPool.
    1. Conv2d -> BatchNorm2d -> ReLU -> MaxPool2d
    2. Conv2d -> BatchNorm2d -> ReLU -> MaxPool2d
    3. Conv2d -> BatchNorm2d -> ReLU -> MaxPool2d
    4. Conv2d -> BatchNorm2d -> ReLU -> MaxPool2d
    Finally, a linear layer projects the flattened features to the desired output dimension.
    Inputs:
        in_channels: Number of input channels (e.g., 3 for RGB images)
        hidden_size: Number of channels in the conv layers
        output_dim: Dimension of the output feature vector
        input_resolution: Height/Width of the input images (assumed square)
    Outputs:
        A feature vector of size (batch_size, output_dim)
    """
